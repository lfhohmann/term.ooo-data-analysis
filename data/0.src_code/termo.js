                    ...
                    return function (i, t) {
                        ...
                        for (o.method = i, o.arg = t; ; ) {
                            ...
                            if ("next" === o.method) o.sent = o._sent = o.arg;
                                ...
                                "return" === o.method &&
                                    o.abrupt("return", o.arg);
                            r = g;
                            var u = l(a, e, o);
                            if ("normal" === u.type) {
                                if (((r = o.done ? d : A), u.arg === p))
                                    continue;
            ...
            (M.prototype = {
                        ...
                        if (n.tryLoc <= this.prev) {
                            ...
                            if (u && c) {
                                if (this.prev < n.catchLoc)
                                    return i(n.catchLoc, 1);
                                if (this.prev < n.finallyLoc)
                                    return i(n.finallyLoc);
                            } else if (u) {
                                if (this.prev < n.catchLoc)
                                    return i(n.catchLoc, 1);
                            } else {
                ...
                finish: function (a) {
                    for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                        ...
                        if (o.finallyLoc === a)
                            return (
                                this.complete(o.completion, o.afterLoc), j(o), p
                            );
                    }
                },
                catch: function (a) {
                      ...
                      (o = {
                          configurable:
                              "configurable" in o
                                  ...
                                  : r.configurable,
                          enumerable:
                              "enumerable" in o ? o.enumerable : r.enumerable,
                          writable: 0,
                      }));
              }
              return mo(a, e, o);
...
(bo.exports = function (a, e, o, r) {
    ...
    ir(o) &&
        ...
        (i = mr(o)).source ||
            (i.source = Ar.join("string" == typeof u ? u : ""))),
        a !== rr
            ? (t ? !s && a[e] && (n = 1) : delete a[e],
              n ? (a[e] = o) : nr(a, e, o))
            : n
            ? (a[e] = o)
            : sr(e, o);
    ...
    zr = function (a) {
        return function (e, o, r) {
            ...
            if (a && o != o) {
                ...
                for (; n > s; s++)
                    if ((a || s in t) && t[s] === o) return a || s || 0;
            return !a && -1;
        };
    },
    ...
    (Xn = function (a) {
        ...
        if (
            ...
            g
                ...
                : es &&
                  i &&
                  (u.lastIndex = u.global ? i.index + i[0].length : r),
            rs &&
                i &&
                i.length > 1 &&
    ...
    _l
        ...
        : (kl =
              "onreadystatechange" in Kl("script")
                  ? function (a) {
                        Vl.appendChild(Kl("script")).onreadystatechange =
                            function () {
...
var Vm,
    ...
    ZA = function (a) {
        oA(bA, aA, function () {
            var e = a.facade;
            DA
                ? SA.emit("rejectionHandled", e)
                : WA("rejectionhandled", e, a.value);
        });
    },
    _A = function (a, e, o) {
        return function (r) {
    ...
    ag = function (a, e, o) {
        if (!a.done) {
            ...
            try {
                if (a.facade === e)
                    throw OA("Promise can't be resolved itself");
                var r = HA(e);
                r
                    ? vA(function () {
                          var o = { done: 0 };
...
var Sd = k(function () {
        if ("function" == typeof ArrayBuffer) {
            ...
            Object.isExtensible(a) &&
                Object.defineProperty(a, "a", { value: 8 });
        }
    }),
    Ld = k,
    Ud = pa,
        ...
        if (
            ...
            d ||
                (((u = e(function (a, e) {
                    ...
                    var o = hp(new n(), a, u);
                    return (
                        null != e && Ap(e, o[t], { that: o, AS_ENTRIES: r }), o
                    );
                })).prototype = s),
                (s.constructor = u)),
    ...
    kp = {
                ...
                Ep(t, {
                    clear: function () {
                        for (var a = n(this), e = a.index, o = a.first; o; )
                            (o.removed = 1),
                                o.previous &&
                                    (o.previous = o.previous.next = void 0),
                                delete e[o.index],
                                (o = o.next);
                        (a.first = a.last = void 0),
                            zp ? (a.size = 0) : (this.size = 0);
                    },
                    delete: function (a) {
                        var e = this,
                            o = n(e),
        ...
        setStrong: function (a, e, o) {
            ...
            jp(
                ...
                function () {
                    for (
                        var a = t(this), e = a.kind, o = a.last;
                        o && o.removed;
        ...
        return (
            t(e, [
                ...
                },
                {
                    key: "letterToDuo",
                    value: function (a, e) {
                        var o = this.shadowRoot.getElementById(
                            "kbd_".concat(a)
                        );
                        if (o) {
                            if (
                            ...
                            o.style.background =
                                "linear-gradient(to right, ".concat(
                                    r.join(","),
                                    ")"
                                );
                        }
                ...
                },
                {
                    ...
                    value: function (a, e) {
                        ...
                        if (o) {
                            ...
                            o.style.background = "conic-gradient(".concat(
                                r.join(","),
                                ")"
                            );
                        }
                    ...
                    value: function (a, e) {
                        var o =
                                arguments.length > 2 && void 0 !== arguments[2]
                                    ? arguments[2]
                                    : 1,
                            r = this.shadowRoot.getElementById(
                                "kbd_".concat(a)
                            );
                        r &&
                            ("right" === e &&
                ...
                },
                {
                    ...
                    value: function () {
                        var a,
                            e =
                                "true" ==
                                (null !== (a = this.getAttribute("stats")) &&
                                void 0 !== a
                                    ? a
                                    : "true");
                        this.shadowRoot.getElementById("stats").style.display =
                            e ? "flex" : "none";
                    },
                },
                {
            ...
            t(e, [
                ...
                },
                {
                    ...
                    value: function (a) {
                        ...
                        e.focus(),
                            (this.open = 1),
                            Gf(e, "0.25s linear popup forwards");
                    },
                },
                {
                    key: "popoff",
...
Bb(
    {
        ...
        forced: !(
            (!Cb &&
                ((fb = Eb(String.prototype, "startsWith")),
                fb && !fb.writable)) ||
            Cb
        ),
    },
    {
        startsWith: function (a) {
            ...
            xb(a);
            var o = Qb(
                    Ib(arguments.length > 1 ? arguments[1] : void 0, e.length)
                ),
                r = Db(a);
...
vs("search", function (a, e, o) {
    return [
        ...
        function (a) {
            ...
            var s = ev(r, i);
            return (
                _b(r.lastIndex, n) || (r.lastIndex = n),
                null === s ? -1 : s.index
            );
        },
    ];
        ...
        return [
            ...
            function (a, i) {
                ...
                for (var m = []; ; ) {
                    ...
                    if ((ih(m, A), !c)) break;
                    "" === Wv(A[0]) &&
                        (t.lastIndex = Xv(n, Vv(t.lastIndex), l));
                }
    ...
    Lh = (function () {
        ...
        function e() {
            ...
            for (var i = arguments.length, t = new Array(i), n = 0; n < i; n++)
                t[n] = arguments[n];
            return (
                M(g((o = a.call.apply(a, [this].concat(t)))), Sh),
                M(g(o), Th),
                o
            );
        }
        return (
            t(e, [
                        ...
                        if (
                            ...
                            var e = Oh(),
                                o = function () {
                                    ...
                                    var r = String(23 - o.getHours()).padStart(
                                            2,
                                            "0"
                                        ),
                                        i = String(
                ...
                },
                {
                    ...
                    value: function () {
                        null !== this.raf &&
                            (clearInterval(this.raf), (this.raf = null));
                    },
                },
                {
                    key: "update",
                    value: function () {
                        var a,
                            e =
                                "true" ==
                                (null !== (a = this.getAttribute("stato")) &&
                                void 0 !== a
                                    ? a
                                    : "false"),
                        ...
                        D(this, Sh, Rh).call(this) &&
                            t.appendChild(
                                Pf(
                                    '<b>💀</b><span><div class="stats_histo">0</div></span>'
                                )
                            );
                        var s,
                ...
                },
                {
                    ...
                    value: function (a, e) {
                        ...
                        var o =
                            a.games > 0
                                ? Math.round((100 * a.wins) / a.games)
                                : 0;
                        (this.shadowRoot.getElementById("stats_pct").innerText =
                            "".concat(o, "%")),
                            (this.shadowRoot.getElementById(
                                "stats_streak"
                            ).innerText = a.curstreak),
                            (this.shadowRoot.getElementById(
                                "stats_maxstreak"
                            ).innerText = a.maxstreak);
        ...
        return (function () {
            ...
            return (
                ...
                (e.prototype.set = function (e, o) {
                    ...
                    ~r
                        ? (this.__entries__[r][1] = o)
                        : this.__entries__.push([e, o]);
                }),
            ...
            t(n, [
                ...
                },
                {
                    ...
                    value: function () {
                        for (var a = [], e = 0; e < 5; ++e)
                            a.push(
                                "<div lid=".concat(e, ' class="letter"></div>')
                            );
                        return a.join("");
                    },
                },
        ...
        return (
            t(e, [
                ...
                },
                {
                    ...
                    value: function () {
                        var a =
                            this.shadowRoot.querySelectorAll("wc-row").length;
                        return (
                            this.shadowRoot
                                .getElementById("hold")
                                .append(
                                    Pf(
                                        "<wc-row termo-row=".concat(
                                            a,
                                            "></wc-row>"
                                        )
                                    )
                        ...
                        if (-1 != e) {
                            for (
                                ...
                                this.shadowRoot
                                    .getElementById("hold")
                                    .removeChild(o[r]);
                            for (var i = Math.min(e, o.length); i < e; ++i)
                                this.addRow();
                        }
                    },
                },
...
if (Kw) {
    ...
    (vB = (bB = function (a) {
        ...
        (wB = (hB = function (a, e, o) {
            ...
            if (i + (o = void 0 === o ? r - i : oB(o)) > r)
                throw EB("Wrong length");
        ...
        for (s.s(); !(t = s.n()).done; ) {
            ...
            for (var x = {}, j = new Set(), M = 0; M < 5; ++M) {
                ...
                if ("wrong" === c[M])
                    ...
                    (r[M] = I),
                        (x[I] =
                            (null !== (C = x[I]) && void 0 !== C ? C : 0) + 1);
                } else if ("place" === c[M]) {
                    var N;
                    o[M].add(I),
                        (x[I] =
                            (null !== (N = x[I]) && void 0 !== N ? N : 0) + 1);
                }
            }
            n.clear();
        ...
        return (
            t(a, [
                ...
                },
                {
                    ...
                    value: function () {
                        for (
                            var a = this.board.getLetters(), e = 1;
                            e < 5;
                            ++e
                        ) {
                            ...
                            if ("" == a[o].innerText)
                                return (
                                    (this.cursor = o), this.updateEdit(), a[o]
                                );
                        }
...
Qy(
    { target: "Array", proto: 1, forced: !Ny },
    {
        splice: function (a, e) {
            ...
            for (i = Iy(u, r), t = 0; t < r; t++)
                (n = l + t) in u && Cy(i, t, u[n]);
            if (((i.length = r), o < r)) {
                for (t = l; t < c - r; t++)
                ...
                for (t = c - r; t > l; t--)
                    (s = t + o - 1),
                        (n = t + r - 1) in u ? (u[s] = u[n]) : delete u[s];
                ...
                },
                {
                    ...
                    value: function () {
                        if (!this.gameOver) {
                            this.tries.length > 0 &&
                                0 ===
                                    this.tries[this.tries.length - 1].length &&
                                this.tries.pop(),
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        if (
                            ...
                            if (null !== o)
                                return this.event("commitError", { msg: o });
                        }
                        this.locked = 1;
                        var r = this.getLetters();
                        if ((this.getRow().setEdit(-1), void 0 !== Xf[a]))
                            for (var i = Xf[a], t = 0; t < 5; ++t)
                                r[t].innerText = i[t];
                ...
                },
                {
                    ...
                    value: function (a) {
                        ...
                        if ("backspace" === a) {
                            ...
                            return (
                                (o &&
                                    null != this.curTry[this.cursor.cursor]) ||
    ...
    (hE ||
        (GE(
            (tQ = (iQ = function () {
                ...
                return (
                    vE && hQ && wQ(rQ, e, { configurable: 1, set: o }), BQ(e, a)
                );
            }).prototype),
            "toString",
            function () {
    ...
    return yD(this, void 0, void 0, function () {
        ...
        return ED(this, function () {
            if (
                ...
                if (
                    ((o = a["text/plain"]), FD.clipboardData.setData("Text", o))
                )
                    return [2, 1];
                throw new Error(
...
var qD = (function () {
    function a(a, e) {
        ...
        this.presentationStyle =
            null !== (o = null == e ? void 0 : e.presentationStyle) &&
            void 0 !== o
                ? o
                : "unspecified";
    }
            ...
            return [
                ...
                new Promise(function (e, o) {
                    ...
                    r.addEventListener("load", function () {
                        ...
                        "string" == typeof a
                            ? e(a)
                            : o("could not convert blob to string");
                    }),
                        r.readAsText(a);
                }),
            ];
            ...
            switch (u.label) {
                ...
                case 4:
                    return (
                        (s = {}),
                        a.presentationStyle &&
                            (s.presentationStyle = a.presentationStyle),
                        [2, new kD(e, s)]
                    );
            }
        });
        ...
        return ED(this, function (i) {
            switch (i.label) {
                ...
                case 4:
                    if (
                        ((o = i.sent()),
                        !GD(a, "text/plain") && !GD(a, "text/html"))
                    )
                        throw o;
                    return [3, 5];
                case 5:
                        ...
                        switch ((a.prev = a.next)) {
                            case 0:
                                (o = e.curRow),
                                    (r = e.won ? o + 1 : "X"),
                                    (i =
                                        null === vy(e.normSolution, e.tries)
                                            ? "*"
                                            : ""),
                                    (t =
                                        rb.curstreak > 0
...
(hg = Mc),
    window.addEventListener("error", function (a) {
        var e, o;
        return yg(
            null == a || null === (e = a.error) || void 0 === e
                ? void 0
                : e.message,
            null == a || null === (o = a.error) || void 0 === o
                ? void 0
                : o.stack
        );
    }),
    window.addEventListener("unhandledrejection", function (a) {
        var e;
        return yg(
            null == a || null === (e = a.reason) || void 0 === e
                ? void 0
                : e.message,
            "[Promise]"
        );
                            ...
                            switch ((e.prev = e.next)) {
                                case 0:
                                    if (
                                        ...
                                        for (
                                            i = 0, t = Object.keys(kx);
                                            i < t.length;
                                            i++
                                        )
                                            (n = t[i]),
                                                (kx[n][o.idx] = null),
                                                xw.kbd.letterToMulti(
                                                    xc,
                                                    n,
                                                    kx[n],
                                                    0
        ...
        (function (a) {
            var e = (function (a) {
                try {
                    var e;
                    return JSON.parse(
                        null !== (e = window.localStorage.getItem(a)) &&
                            void 0 !== e
                            ? e
                            : "null"
                    );
            ...
            if (
                e &&
                (zx(tb, e.config), zx(rb, e.stats), zx(ib, e.meta), e.state)
            )
